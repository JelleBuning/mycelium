...
namespace Mycelium.Api.EntityFramework.Migrations
{
    ...
    [Migration("20260923073716_AddOsNameAndVersionToDeviceInformation")]
    partial class AddOsNameAndVersionToDeviceInformation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mycelium.Api.EntityFramework.Entities.DeviceSoftware", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mycelium.Api.EntityFramework.Entities.Organisation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mycelium.Api.EntityFramework.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mycelium.Api.EntityFramework.Entities.Device", b =>
                {
                    ...
                    b.HasOne("Mycelium.Api.EntityFramework.Entities.DeviceSecurity", "DeviceSecurity")
                        .WithMany()
                        .HasForeignKey("DeviceSecurityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mycelium.Api.EntityFramework.Entities.Organisation", null)
                        .WithMany("Devices")
            ...
            modelBuilder.Entity("Mycelium.Api.EntityFramework.Entities.DeviceDisk", b =>
                {
                    b.HasOne("Mycelium.Api.EntityFramework.Entities.Device", null)
                        .WithMany("Disks")
            ...
            modelBuilder.Entity("Mycelium.Api.EntityFramework.Entities.User", b =>
                {
                    b.HasOne("Mycelium.Api.EntityFramework.Entities.Organisation", "Organisation")
                        .WithMany("Users")
                        .HasForeignKey("OrganisationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
